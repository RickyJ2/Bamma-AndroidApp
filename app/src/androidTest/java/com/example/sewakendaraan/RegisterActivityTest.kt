...
class RegisterActivityTest {
    ...
    fun registerActivityTest() {
        ...
        textInputEditText.perform(replaceText("unitTesting"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(replaceText("mail"), closeSoftKeyboard())
        ...
        textInputEditText4.perform(replaceText("081234567"), closeSoftKeyboard())
        ...
        textInputEditText5.perform(replaceText("mail@mail.com"))
        ...
        textInputEditText7.perform(replaceText("12345678"))
