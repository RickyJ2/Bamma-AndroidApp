...
class RVItemDaftarMobil(private val data: ArrayList<DaftarMobil>,
                        private val clickListener: (DaftarMobil) -> Unit): RecyclerView.Adapter<RVItemDaftarMobil.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val iv = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.rv_item_kendaraan, parent, false)){
